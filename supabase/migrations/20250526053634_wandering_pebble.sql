/*
  ...
  1. New Data
    - Insert sample users
    - Insert properties from existing data
    - Insert property images
    - Insert yield data
    
  2. Notes
    - All properties are assigned to the first user as owner
    - Images are preserved from the original data
    - Yield data is maintained where available
*/
...
INSERT INTO property_images (property_id, url, position) VALUES
  ('1', 'https://images.pexels.com/photos/2751755/pexels-photo-2751755.jpeg', 0),
  ('1', 'https://images.pexels.com/photos/5561519/pexels-photo-5561519.jpeg', 1),
  ('1', 'https://images.pexels.com/photos/158028/belgrade-serbia-fruits-market-158028.jpeg', 2),
  ('1', 'https://images.pexels.com/photos/8353801/pexels-photo-8353801.jpeg', 3),
  
  ('2', 'https://images.pexels.com/photos/440731/pexels-photo-440731.jpeg', 0),
  ('2', 'https://images.pexels.com/photos/175370/pexels-photo-175370.jpeg', 1),
  ('2', 'https://images.pexels.com/photos/247599/pexels-photo-247599.jpeg', 2),
  ('2', 'https://images.pexels.com/photos/2132250/pexels-photo-2132250.jpeg', 3),
  
  ('3', 'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg', 0),
  ('3', 'https://images.pexels.com/photos/7174114/pexels-photo-7174114.jpeg', 1),
  ('3', 'https://images.pexels.com/photos/221457/pexels-photo-221457.jpeg', 2),
  ('3', 'https://images.pexels.com/photos/206172/pexels-photo-206172.jpeg', 3),
  
  ('4', 'https://images.pexels.com/photos/3855622/pexels-photo-3855622.jpeg', 0),
  ('4', 'https://images.pexels.com/photos/3970330/pexels-photo-3970330.jpeg', 1),
  ('4', 'https://images.pexels.com/photos/2760243/pexels-photo-2760243.jpeg', 2),
  ('4', 'https://images.pexels.com/photos/1129371/pexels-photo-1129371.jpeg', 3),
  
  ('5', 'https://images.pexels.com/photos/3493583/pexels-photo-3493583.jpeg', 0),
  ('5', 'https://images.pexels.com/photos/2255459/pexels-photo-2255459.jpeg', 1),
  ('5', 'https://images.pexels.com/photos/3629537/pexels-photo-3629537.jpeg', 2),
  ('5', 'https://images.pexels.com/photos/5331303/pexels-photo-5331303.jpeg', 3),
  
  ('6', 'https://images.pexels.com/photos/4750273/pexels-photo-4750273.jpeg', 0),
  ('6', 'https://images.pexels.com/photos/2749165/pexels-photo-2749165.jpeg', 1),
  ('6', 'https://images.pexels.com/photos/639105/pexels-photo-639105.jpeg', 2),
  ('6', 'https://images.pexels.com/photos/421797/pexels-photo-421797.jpeg', 3);

-- Insert yield data
INSERT INTO yield_data (property_id, estimated_yield, varieties_grown, harvest_season) VALUES
  ('1', 3.5, ARRAY['Alphonso', 'Kesar'], 'April to June'),
  ('3', 4.2, ARRAY['Kesar', 'Alphonso', 'Banganapalli', 'Dasheri'], 'March to July'),
  ('5', 3.8, ARRAY['Banganapalli', 'Mallika', 'Alphonso', 'Totapuri'], 'March to August'),
  ('6', 1.5, ARRAY['Alphonso', 'Banganapalli', 'Neelam'], 'April to July');